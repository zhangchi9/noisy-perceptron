function [CV_ISI,CV_ISI2,SPKS_COR,COR_I] = dynamics_analysis_with_noise(W)
...
CV_ISI = nanmean(CV_ISI_j);
CV_ISI2 = nanmean(CV_ISI_j2);
SPKS_COR = nanmean(SPKS_COR_j);
COR_I = nanmean(COR_I_j);
end
